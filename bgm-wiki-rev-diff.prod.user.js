...
// @require      https://cdn.jsdelivr.net/npm/diff2html@3.4.7/bundles/js/diff2html.min.js
...
function compare(revID1, revID2) {
    ...
    Promise.all([p1, p2])
        ...
        for (const page of values) {
            contents.push(parser_1.parseRevDetails(page));
        }
...
const axios_1 = __webpack_require__("./node_modules/axios/index.js");
